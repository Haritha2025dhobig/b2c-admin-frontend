...
// ✅ Define the shape of a Service Period
...
export default function ServicePeriodPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      >
        <FormFields formData={formData} errors={errors} setFormData={setFormData} />
      </CustomDialog>
...
function FormFields({
  ...
  formData: { service_period_code: string; service_period_name: string; service_period_description: string };
  errors: { service_period_code: string; service_period_name: string; service_period_description: string };
  ...
  return (
    <div className="flex flex-col gap-4 mt-2">
      <TextField
        ...
        onChange={(e) => setFormData({ ...formData, service_period_code: e.target.value })}
      ...
      <TextField
        ...
        onChange={(e) => setFormData({ ...formData, service_period_name: e.target.value })}
      ...
      <TextField
        ...
        onChange={(e) => setFormData({ ...formData, service_period_description: e.target.value })}
